...
<template>
    <section class="introduction" aria-label="Úvodní sekce">
		<div class="container-custom flex items-end justify-between">

            <!-- Floating text in bg -->
            <span class="floating-text" aria-hidden="true">Grah Hill</span>

            <!-- Floating head -->
            <picture>
                <source srcset="../../assets/img/hero-head.webp" type="image/webp">
                <source srcset="../../assets/img/hero-head.png" type="image/png">
                <img class="head" src="../../assets/img/hero-head.png" alt="Graham Hill - legendární britský jezdec Formule 1, dvojnásobný mistr světa" loading="eager">
            </picture>
            ...
            <picture>
                ...
                <img class="formula" src="../../assets/img/formule.png" alt="Formule 1 závodní vůz" loading="eager" aria-hidden="true">
            </picture>
            ...
            <div class="left-content">
                ...
                <div class="buttons">
                    <a href="#our-coins" class="btn" aria-label="Zjistit více o investičních mincích">
                        Zjistit více
                    </a>
                    <a href="#our-coins" class="btn btn-transparent px-9" aria-label="Přejít do e-shopu a koupit investiční mince">
                        <svg width="100%" height="100%" viewBox="0 0 84 82" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" aria-hidden="true">
            ...
            <picture>
                ...
                <img class="coins" src="../../assets/img/hero-coins.png" alt="Kolekce investičních mincí mistrů světa Formule 1 - Graham Hill, Alan Jones, Nigel Mansell" loading="eager">
            </picture>

            <!-- Scroll down icon -->
            <svg class="scroll-down" width="17" height="268" viewBox="0 0 17 268" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Posunout dolů na další sekci" role="img">
                <title>Posunout dolů</title>
