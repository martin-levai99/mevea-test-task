<template>
    <head>
        ...
        <meta name="title" :content="props.title || 'Motorsport LEGENDS - Investiční mince mistrů Formule 1'" />
        ...
        <meta name="author" content="Motorsport LEGENDS" />
        ...
        <!-- Performance: Load fonts with display swap -->
